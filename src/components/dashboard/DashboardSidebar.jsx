...
//   return (
//     <div className="w-64 bg-gray-900 h-screen p-4 top-31 z-0">
...
const DashboardSidebar = () => {
  ...
  return (
    <>
      ...
      <div className="bg-gray-900 p-4 text-white flex justify-between items-center md:hidden">
      ...
      <div
        ...
        } w-64 bg-gray-900 h-screen p-4 top-0 left-0 z-50 fixed transform transition-transform duration-300 ease-in-out md:translate-x-0 md:static`}
      >
        <h2 className="text-2xl font-bold text-white mb-4 hidden md:block">
          Dashboard
        </h2>
        <ul>
          <li className="mb-4 flex items-center">
