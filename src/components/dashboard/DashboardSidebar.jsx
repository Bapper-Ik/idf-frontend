...
const DashboardSidebar = () => {
  ...
  return (
    <aside className="lg:w-64 xl:w-80 bg-gray-900 h-screen p-4 top-16 z-0 lg:sticky lg:top-0">
      ...
      <nav>
        ...
        <div
          className={`${
            isOpen ? "block" : "hidden"
          } lg:flex lg:flex-col lg:items-center lg:w-auto lg:min-h-fit`}
        >
          <ul className="lg:flex lg:flex-col lg:items-center">
            <li className="flex items-center mb-4 lg:mb-0">
              <svg
                className="w-6 h-6 text-gray-400 mr-2"
                fill="none"
                stroke="currentColor"
